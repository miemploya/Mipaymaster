@echo off
REM ============================================
REM MiPayMaster Auto-Absent Cron Job
REM Runs daily to mark absent employees who didn't clock in
REM ============================================

REM Set paths
set PHP_PATH=C:\xampp\php\php.exe
set CRON_PATH=C:\xampp\htdocs\Mipaymaster\cron\cron_auto_absent.php
set LOG_PATH=C:\xampp\htdocs\Mipaymaster\logs\cron_auto_absent.log
